...
import (
	...
	"github.com/cheny-alf/kube-score/score/apps"
	"github.com/cheny-alf/kube-score/score/checks"
	"github.com/cheny-alf/kube-score/score/container"
	"github.com/cheny-alf/kube-score/score/cronjob"
	"github.com/cheny-alf/kube-score/score/deployment"
	"github.com/cheny-alf/kube-score/score/disruptionbudget"
	"github.com/cheny-alf/kube-score/score/hpa"
	"github.com/cheny-alf/kube-score/score/ingress"
	"github.com/cheny-alf/kube-score/score/meta"
	"github.com/cheny-alf/kube-score/score/networkpolicy"
	"github.com/cheny-alf/kube-score/score/podtopologyspreadconstraints"
	"github.com/cheny-alf/kube-score/score/probes"
	"github.com/cheny-alf/kube-score/score/security"
	"github.com/cheny-alf/kube-score/score/service"
	"github.com/cheny-alf/kube-score/score/stable"
